...
class mclass:
    ...
    def calc(self):
        ...
        if self.tkvar.get() == '3D_DCSMFM_05_nm':
            name_textfile_load = 'D:/3D-DCSM-FM/A08_newrgh_steric_dicoww_pieter/Rm_Neightbourlayers=1,WD_min=1.5,nl=(2, 1)'
        elif self.tkvar.get() == 'DCSMFM_05_nm':
            name_textfile_load = 'D:/DCSM-FM/A06_pieter/Progres1_HAM317'
        elif self.tkvar.get() == 'DCSMFM_100_m':
            name_textfile_load = 'unknown'
        elif self.tkvar.get() =='DCSM_zuno_NOOS':
            name_textfile_load = 'D:/DCSMv6-ZUNOv4/Rm_Neightbourlayers=1,WD_min=1.5'
        else:
            name_textfile_load = 'D:/DCSM-FM/A06_pieter/Progres1_HAM317'
